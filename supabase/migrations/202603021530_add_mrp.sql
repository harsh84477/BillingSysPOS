-- Add MRP (Maximum Retail Price) to products and bill_items
...
-- Update existing records to set MRP = selling_price if MRP is currently 0.
-- This ensures backward compatibility so existing products don't show 0 MRP.
UPDATE public.products
SET mrp_price = selling_price
WHERE mrp_price = 0;

UPDATE public.bill_items
SET mrp_price = unit_price
WHERE mrp_price = 0;
