-- ============================================================
-- APPLY NOW: Multi-tenant Business System Migration
...
-- Step 4: Safely change app_role enum if not already changed
DO $$
BEGIN
  -- Check if 'manager' role already exists (means migration was already applied)
  IF NOT EXISTS (
...
-- Step 9: Create business function
...
-- Step 10: Join business function
...
-- ============================================================
-- Step 12: Update ALL RLS policies (drops old ones first)
-- ============================================================
...
-- === Bill Items (uses JOIN to bills for business scoping) ===
...
-- Add show_gst_in_billing and show_discount_in_billing if missing
...
-- Add icon column to products if missing
