    ...
    <div style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
      <div style={{
        ...
        <div style={{
          ...
          gap: '20px',
          paddingRight: '4px', /* breathing room for the scrollbar */
            ...
            <SettingsCard title="Footer" subtitle="Customize the footer section of your printed invoices" icon="📝" accent="#8b5cf6" footer={renderSaveBtn()}>
              ...
              <div style={{ padding: '12px 0' }}>
                ...
                <textarea value={settings?.print_terms_conditions || ''} onChange={(e) => u({ print_terms_conditions: e.target.value })}
                  ...
                  style={{
                    width: '100%', padding: '10px 13px', fontSize: '13px', borderRadius: '10px', border: `1.5px solid ${T.color.border}`,
        ...
        {/* ═══ RIGHT: Live Preview — fixed height, never scrolls with the page ═══ */}
        <div style={{
          width: '450px',
          flexShrink: 0,
          display: 'flex',
          flexDirection: 'column',
          /* Full height of the flex row — always visible, no sticky needed */
          height: '100%',
          overflow: 'hidden',
        }}>
          {/* Card wrapper */}
          <div style={{
            ...
            {/* Preview content — scrollable within the card */}
            <div style={{
              flex: 1,
              overflowY: 'auto',
              overflowX: 'hidden',
        ...
        @media (max-width: 1024px) {
          ...
          /* Left column: show all content, no internal scroll on mobile */
          .print-settings-grid > div:first-child {
            overflow-y: visible !important;
            overflow-x: visible !important;
            padding-right: 0 !important;
          }
          /* Right preview: auto height on mobile */
