...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Pending Orders', href: '/pending-orders', icon: FileText, roles: ['owner', 'manager', 'cashier', 'salesman'], badgeKey: 'drafts' },
      { name: 'Sales Orders', href: '/salesman-orders', icon: FileText, roles: ['owner', 'manager'] },
...
const mobileNavItems = [
  ...
  { name: 'Orders', href: '/pending-orders', icon: FileText, roles: ['salesman'] },
